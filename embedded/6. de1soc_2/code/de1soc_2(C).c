/* address_map_arm.h: This files provides address values that exist in the system */
...
/* interrupt ID.h: This file provides interrupt IDs */
...
extern volatile int LED_pattern = 1; // LED display pattern (00000 00001)
extern volatile int HEX_pattern = 1; // HEX0 display pattern (000 0001)
...
void config_KEYs()
{
	IO_port(KEY_BASE + 8) = 0xF; // enable interrupts for all four KEYs
}
...
void config_GIC(void)
{
	...
	IO_port(MPCORE_GIC_DIST + ICDIPTR + 0x48) = 0x00000100; // interrupt ID=72, 73
