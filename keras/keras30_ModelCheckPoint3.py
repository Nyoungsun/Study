...
MCP = ModelCheckpoint(monitor='val_loss', mode = 'auto', save_best_only=True, verbose = 1, filepath = path + 'keras30_ModelCheckPoint3.hdf5') 
...
model3 = load_model(path + 'keras30_ModelCheckPoint3.hdf5')
