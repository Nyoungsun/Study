...
start = t.time()
model.fit(x_train, y_train, epochs = 100, batch_size = 1, validation_split=0.15)
fin = t.time()

# RMSE:  52.40147855969858
# R2:  0.6114517287643387
...
submission.to_csv(path + 'submission_0107.csv')