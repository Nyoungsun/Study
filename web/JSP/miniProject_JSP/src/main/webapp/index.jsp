...
<body>
	...
	<div class="container">
		<h1>
			...
			if (id == null) {
			%>
			<a href="./member/writeForm.jsp">Sign up</a> <a
				href="./member/loginForm.jsp">Sign in</a>
			<%
			} else {
			...
			%>
			<a href="./member/logout.jsp">Logout</a> <a
				href="./member/updateForm.jsp">Edit</a> <a
				href="./member/deleteForm.jsp">Withdrawal</a> <a
				href="./board/boardWriteForm.jsp">Writing</a>
			<%
			}
			%>
			<a href="./board/boardList.jsp?pg=1">board</a>
		</h1>
	</div>
...
void main() {
  ...
  */
  ...
  gl_FragColor = vec4(rgb, 1.0);
	...
	<script
		src='https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.3.1/p5.min.js'></script>
